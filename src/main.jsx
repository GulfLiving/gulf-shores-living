...
const images = {
  ...
  image: '/images/gulf-shores-living/entrance.jpg',
        ...
        <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-[1fr_0.9fr] lg:items-center">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="overflow-hidden rounded-3xl bg-white/5 ring-1 ring-white/10"><img src="/images/gulf-shores-living/View of bay 2.jpg" alt="Bay view from Gulf Shores Living" className="h-56 w-full object-cover object-center" /></div>
